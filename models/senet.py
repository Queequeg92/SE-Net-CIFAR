...
class SeResNet(nn.Module):
    def __init__(self, block, num_blocks, filters, num_classes=10):
...
def SeWideResNet_28_10(num_classes=10):
    return SeResNet(PreActBlock, [4, 4, 4], [160, 320, 640], num_classes)
